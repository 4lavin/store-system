                    ...
                    <nav aria-label="Page navigation example d">
                        <ul class="pagination d-flex justify-content-end">
                            <li class="page-item <?php echo isset($page_no) && $page_no <= 1 ? "disabled" : '' ?>">
                                <a class="page-link" href="cart.php?page_no=<?php echo $prev_page_no ?>"
                                    tabindex="-1">&laquo;</a>
                            </li>
                            <?php
                            for ($counter = 1; $counter <= $total_page_no; $counter++) {
                                ...
                                <?php } else { ?>
                                    <li class="page-item"><a class="page-link"
                                            href="cart.php?page_no=<?php echo $counter ?>"><?php echo $counter ?></a>
                                    </li>
                                <?php }
                            } ?>
                            <li
                        ...
                        success: function (data) {
                            if (data == 0) {
                                ...
                                setInterval(function () {
                                    location.href = `cart.php?page_no=${Math.ceil(data + 1 / 5)}`
                                }, 1000);
                            }
                            else {
                                Swal.fire({
                                ...
                                setInterval(function () {
                                    location.href = `cart.php?page_no=${Math.ceil(data / 5)}`
                                }, 1000);
                            }
                        }
                    })
